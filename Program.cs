...
using Hello;
using Hello.Constructors;
using Hello.DataTypes;
using Hello.InterfaceExercises;
using Hello.Operators;
using Hello.ZooManagementSystem;
...
Hello.Constructors.Student st = new Hello.Constructors.Student("Thandi","Motaung");
Console.WriteLine(st.Name);

Teacher tea = new Teacher("Honey", "Sugar");
Console.WriteLine(tea.Name);
Teacher t = new Teacher("Hp", "Met");
Console.WriteLine(t.Name);

Console.WriteLine(Person.GetInstances());
var s1 = new Hello.InterfaceExercises.Student("lk","lk");
...
Console.WriteLine("Minimum lifespan"+ pet1.MinLifespan);

Animal pet2 = new Turtle();
Console.WriteLine(pet2.GetDescription());
Console.WriteLine(pet2.Eat());
Console.WriteLine(pet2.Move());
Console.WriteLine("Minimum lifespan" + pet2.MinLifespan);

Animal pet3 = new GoldenEagle();
Console.WriteLine(pet3.GetDescription());
Console.WriteLine(pet3.Eat());
Console.WriteLine(pet3.Move());
Console.WriteLine("Minimum lifespan" + pet3.MinLifespan);
